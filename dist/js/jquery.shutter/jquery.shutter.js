	...
	$.fn.tzShutter = function(options){
		...
		// Проверка поддержки холста. Работает во всех современных браузерах:
		...
		if(!supportsCanvas){
			...
			// Если нет поддержки canvas, свяжите
			// функции обратного вызова сразу и выход:
		...
		window.setTimeout(function(){
			...
			img.onload = function(){
				...
				// Привязка пользовательских событий открытия 
				// и закрытия, которые запускают анимацию затвора.
				...
				// Запись информации о времени, если
				// консоли веб-разработки firebug:
